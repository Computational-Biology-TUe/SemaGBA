...
function ODEs!(du,u,p,t)
    ...
    ref_body_weight, ref_net_energy_intake, ref_blood_glucose, ref_glp_1, ref_insulin, ref_insulin_sen, ref_leptin, ref_leptin_sen, ref_glucotoxicity, ref_lipotoxicity, ref_semaglutide_subcutaneous, ref_beta_cell_functioning, ref_agrp, ref_pomc, ref_dopamine, absorption_rate, elimination_rate = p

    # unpack u (current state variables)
    current_body_weight, current_net_energy_intake, current_blood_glucose, current_glp_1, current_insulin, current_insulin_sen, current_leptin, current_leptin_sen, current_glucotoxicity, current_lipotoxicity, current_semaglutide_subcutaneous, current_semaglutide_plasma, current_beta_cell_functioning, current_agrp, current_pomc, current_dopamine= u;
