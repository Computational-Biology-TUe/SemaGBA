""" This file contains all inputs to simulate a diabetic patient"""
...
# Ozempic with 0.5 mg semaglutie maintenance dose
...
# Ozempic with 1.0 mg semaglutide maintenance dose
#injection_doses = [injection_0_25_mg, 
#                    injection_0_5_mg, 
#                    injection_1_mg];
#release_times = [[7 *i for i in 1:4],
#                [7 *i for i in 5:8],
#                [7 *i for i in 9:500]];
...
ref_body_weight = initial_body_weight = 89.8 #kg in study 1 from Table 1
...
ref_blood_glucose = initial_blood_glucose  = 174; #mg/dL in study 1 and 2 from Table 1
...
ref_insulin_sen = initial_insulin_sen= 0.4; #dimensionless 
...
ref_glucotoxicity = initial_glucotoxicity = 0.5; #dimensionless 
...
ref_beta_cell_functioning = initial_beta_cell_functioning = 0.5; #dimensionless
